...
public class ModConfig extends HokiConfig {
    ...
    @ConfigOption public final Option<Double> TAX_BONUS = new Option<>("core.tax.bonus", 0.25, "the tax rate of ptt bonus", Config::getDouble);
    @ConfigOption public final Option<Double> TAX_FLY = new Option<>("core.tax.fly", 0.3, "the tax rate of buy fly", Config::getDouble);
    @ConfigOption public final Option<Double> TAX_DEATH_PROTECT = new Option<>("core.tax.death_protect", 0.3, "the tax rate of buy death protect", Config::getDouble);
